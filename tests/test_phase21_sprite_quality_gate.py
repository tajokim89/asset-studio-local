...
def test_phase21_rejects_direction_set_when_one_source_is_much_smaller():
    sources = {
        ...
        "W": _sprite_png(404, 372),
        "SW": _sprite_png(234, 250),  # observed Phase 20 failure
        "NW": _sprite_png(404, 368),
    }
    ...
    assert "SW" in qa["failed_directions"]
    assert qa["stats"]["SW"]["height_ratio"] < 0.82
...
def test_phase21_accepts_direction_set_with_consistent_sprite_sizes():
    sources = {
        ...
        "W": _sprite_png(390, 382),
        "SW": _sprite_png(360, 386),
        "NW": _sprite_png(386, 380),
    }
